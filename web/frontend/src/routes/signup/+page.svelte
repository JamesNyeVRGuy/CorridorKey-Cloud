<script lang="ts">
  ...
  async function handleSignup() {
    ...
    try {
      ...
      created = true;
      // Redirect to pending page instead of showing confirmation card
      setTimeout(() => goto("/pending"), 500);
    } catch (e) {
    ...
    <div class="auth-form">
      ...
      <div class="profile-section">
        <span class="section-hint"
          >Optional — helps us review your application faster</span
        >
        <label class="auth-field">
          ...
          <input
            type="text"
            bind:value={company}
            placeholder="e.g. Corridor Digital"
            onkeydown={onKeydown}
          />
        </label>
        <label class="auth-field">
          ...
          <input
            type="text"
            bind:value={role}
            placeholder="e.g. VFX Artist, Producer, Editor"
            onkeydown={onKeydown}
          />
        </label>
        <label class="auth-field">
          ...
          <input
            type="text"
            bind:value={useCase}
            placeholder="e.g. Green screen compositing for short films"
            onkeydown={onKeydown}
          />
        </label>
      </div>
      ...
      <label class="tos-check">
        ...
        <span
          >I agree to not redistribute content processed through this platform</span
        >
      </label>
      {#if turnstileSiteKey}
